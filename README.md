...
| --- | ---: | --- |
| [Repository regression suite](./.github/workflows/ci.yml) | **4,470 passed, 2 skipped** | Local Python 3.12 release run on 2026-08-24 against [runtime/test commit `08f2b08`](https://github.com/zrb3052796119/CodeLoop/commit/08f2b08); protects implemented behavior, not general agent intelligence. CI reruns the suite on a 3-OS × 2-Python matrix after push. |
